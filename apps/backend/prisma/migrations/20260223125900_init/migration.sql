...
-- CreateEnum
CREATE TYPE "tenants"."StoreModuleKey" AS ENUM ('CATALOG', 'INVENTORY', 'PRICING');
...
-- CreateTable
CREATE TABLE "tenants"."store_modules" (
    "id" UUID NOT NULL,
    "store_id" UUID NOT NULL,
    "module_key" "tenants"."StoreModuleKey" NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "item_variants_store_id_sku_key" ON "catalog"."item_variants"("store_id", "sku");
...
-- CreateIndex
CREATE UNIQUE INDEX "customer_groups_store_id_code_key" ON "parties"."customer_groups"("store_id", "code");
...
-- CreateIndex
CREATE INDEX "price_books_store_id_is_default_idx" ON "pricing"."price_books"("store_id", "is_default");

-- CreateIndex
CREATE UNIQUE INDEX "price_books_store_id_code_key" ON "pricing"."price_books"("store_id", "code");
...
-- CreateIndex
CREATE INDEX "item_prices_store_id_variant_id_idx" ON "pricing"."item_prices"("store_id", "variant_id");

-- CreateIndex
CREATE INDEX "item_prices_customer_group_id_idx" ON "pricing"."item_prices"("customer_group_id");

-- CreateIndex
CREATE INDEX "item_prices_store_id_price_book_id_customer_group_id_idx" ON "pricing"."item_prices"("store_id", "price_book_id", "customer_group_id");

-- CreateIndex
CREATE INDEX "item_prices_store_id_is_active_starts_at_ends_at_idx" ON "pricing"."item_prices"("store_id", "is_active", "starts_at", "ends_at");

-- CreateIndex
CREATE INDEX "discount_rules_store_id_rule_type_idx" ON "pricing"."discount_rules"("store_id", "rule_type");

-- CreateIndex
CREATE INDEX "discount_rules_store_id_code_idx" ON "pricing"."discount_rules"("store_id", "code");

-- CreateIndex
CREATE INDEX "discount_rules_customer_group_id_idx" ON "pricing"."discount_rules"("customer_group_id");

-- CreateIndex
CREATE INDEX "discount_rules_store_id_is_active_starts_at_ends_at_idx" ON "pricing"."discount_rules"("store_id", "is_active", "starts_at", "ends_at");
...
-- CreateIndex
CREATE INDEX "item_activity_projection_store_id_item_id_occurred_at_idx" ON "reporting"."item_activity_projection"("store_id", "item_id", "occurred_at");

-- CreateIndex
CREATE INDEX "item_activity_projection_store_id_variant_id_occurred_at_idx" ON "reporting"."item_activity_projection"("store_id", "variant_id", "occurred_at");

-- CreateIndex
CREATE INDEX "item_activity_projection_store_id_source_type_occurred_at_idx" ON "reporting"."item_activity_projection"("store_id", "source_type", "occurred_at");

-- CreateIndex
CREATE INDEX "item_activity_projection_store_id_source_status_idx" ON "reporting"."item_activity_projection"("store_id", "source_status");

-- CreateIndex
CREATE UNIQUE INDEX "item_activity_projection_store_id_source_ref_key" ON "reporting"."item_activity_projection"("store_id", "source_ref");
...
-- CreateIndex
CREATE INDEX "store_modules_store_id_enabled_idx" ON "tenants"."store_modules"("store_id", "enabled");

-- CreateIndex
CREATE UNIQUE INDEX "store_modules_store_id_module_key_key" ON "tenants"."store_modules"("store_id", "module_key");
...
-- AddForeignKey
ALTER TABLE "tenants"."store_modules" ADD CONSTRAINT "store_modules_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "tenants"."stores"("id") ON DELETE CASCADE ON UPDATE CASCADE;
